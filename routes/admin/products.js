...
const productIndexTemp = require("../../views/admin/products/index");
const productEditTemp = require("../../views/admin/products/edit");
...
router.get("/admin/products", requireAuth, async (req, res) => {
  ...
  res.send(productIndexTemp({ products }));
});
...
router.get("/admin/products/:id/edit", requireAuth, async (req, res) => {
  ...
  res.send(productEditTemp({ product }));
});
...
router.post(
  ...
  upload.single("image"),
  [requireTitle, RequirePrice],
  handleError(productEditTemp, async (req) => {
    const product = await productRepo.getOne(req.params.id);
    return { product };
  }),
  async (req, res) => {
